...
function AdminContent() {
  ...
  useEffect(() => { document.title = "Gateway Control"; }, []);
  ...
  return <div className="protocol-shell min-h-full"><QrImportDialog payload={qrPayload} onOpenChange={open => !open && setQrPayload(null)} /><div className="mx-auto max-w-7xl px-1 py-2 sm:px-4 sm:py-5">
