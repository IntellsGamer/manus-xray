...
export function ClientManagerContent() {
  ...
  const create = trpc.vless.createClient.useMutation({
    onSuccess: () => { setName(""); setTrafficLimit("-1"); setDayLimit("-1"); setSpeedLimitMbps("-1"); toast.success("Client identity created"); refresh(); },
