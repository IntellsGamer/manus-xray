...
import { CalendarClock, Copy, Gauge, HardDrive, KeyRound, MoreHorizontal, Network, Power, RotateCcw, Save, Trash2 } from "lucide-react";
...
export function ClientRegistry({ clients, pending, onToggle, onActivate, onRotate, onResetUsage, onDelete, onCopy, onSavePolicy }: ClientRegistryProps) {
  const [deleteCandidate, setDeleteCandidate] = useState<Pick<ClientRecord, "id" | "name"> | null>(null);
