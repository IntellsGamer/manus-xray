...
import { formatLiveMbps, type LiveThroughputReading } from "@/lib/liveSessionThroughput";
...
type LiveSessionsPanelProps = {
  ...
  throughputs: Record<string, LiveThroughputReading>;
...
export function LiveSessionsPanel({ clients, groups, throughputs, streamConnected, pending, onDisconnectGroup, onUnblockGroup, onSaveAllowedProtocols }: LiveSessionsPanelProps) {
